...
function SymbolPallete(){
	function getFlowShapes(): NodeModel[] {
			...
			let flowShapes: NodeModel[] = [
					{ id: 'Start',width:shapeSize,height:shapeSize, shape: { type: 'Bpmn', shape: 'Event' , event:{event:'Start'}},symbolInfo:{description:{text:"Start"}} },
	...
	return(
			...
			getSymbolInfo={(symbol: NodeModel): SymbolInfo => {
					...
					return { width: symbol.width, height: symbol.height, description: { text: symbol.id } };
				}}
			>
